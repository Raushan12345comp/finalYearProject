export default function CreatePost() {
  return (
    <>
      <div className=" w-[60%] mx-auto flex flex-col justify-center py-8 sm:px-6 lg:px-8">
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6">
              ...
              <div>
                ...
                <button
                  type="submit"
                  className="w-[60%] mx-auto flex justify-center py-2 px-4 bg-indigo-400 hover:bg-indigo-600 text-center text-white rounded-full"
                >
                  Create
                </button>
              </div>
