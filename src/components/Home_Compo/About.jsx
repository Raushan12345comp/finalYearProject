                    ...
                    <div className="about_right">
                        ...
                        <div className="about_details">
                            <section className='a_dt'>
                                ...
                                <div>
                                    <p style={{fontSize:"22px" , fontWeight:"bold"}}>Online Courses</p>
                            ...
                            <section className='a_dt'>
                                ...
                                <div>
                                    <p style={{fontSize:"22px" , fontWeight:"bold"}}>Learn with Expert</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, nam.</p>
                                </div>
                            </section>
                            ...
                            <section className='a_dt'>
                                ...
                                <div>
                                    <p style={{fontSize:"22px" , fontWeight:"bold"}}>Free Books</p>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, nam.</p>
                                </div>
                            </section>
                        </div>
